...
console.log(
  ...
  console.log(
    chalk.green.bold.italic(`(" Your Account Sign Up Succefully `) +
...
if (signUp.name === logiN.name && signUp.number === logiN.number && signUp.Pin === logiN.Pin) {
    ...
    console.log(
      ...
      console.log(
        chalk.bold.blueBright.italic("Your Available Account Balance :")
      );
      console.log(
        chalk.bold.yellow("____________________________________________")
      );

      console.log(
        chalk.bold.green("RS :") + " " + chalk.bold.magentaBright(userBlance)
      );
    ...
    if (optionList.list === "Daily Reward") {
        let DailyReward:any = await inquirer.prompt(
            [
                {
                    name :"dailyMbs",
                    type : "checkbox",
    ...
    if (DailyReward.dailyMbs) {
        ...
        const easyLoad = await inquirer.prompt([
          ...
          let condition2 = true;
          if (
            (easyLoad.easyLoad === "Jazz" || "Zong" || "Telenore" || "Ufone",
            ...
            while (condition2) {
              let getLoad = await inquirer.prompt([
                ...
                },
                {
                  ...
                  message: chalk.bold.yellowBright(
                    "To Perform This Operation Enter Your Pin Code :"
                  ),
                },
              ]);
              if (getLoad.loadPin === logiN.Pin) {
                if (getLoad.amount >= 100 ) {
                  ...
                  console.log(
                    chalk.cyan.bold("The balane of Rs :") +
                      " " +
                  ...
                  console.log(
                    chalk.bold.magentaBright("Your remaining balance is :") +
                      " " +
                      chalk.bold.cyan("Rs : ") +
                  ...
                  condition2 = false;
                    ...
                    console.log(
                        chalk.bold.blueBright("Dear User") +
                          " " +
                          chalk.bold.greenBright(logiN.name) +
                          " " +
                          chalk.bold.red(
                            "You Dont Have Insufficient Balance For This Transaction .!!"
                          )
                      );
                      console.log("");
                  ...
                  console.log(
                    chalk.bold.red("You can't make this transation .!!") +
                      chalk.bold.green(
                        `( enter more than 100 or equal )` +
                          " Then " +
                          chalk.bold.italic.magenta(
                            `{Re-Enter Your Number & Amount}`
                          )
                      )
                  );
                }
                ...
                console.log(
                  chalk.bold.red("Invalid Pin Code .!!") +
                    " " +
        ...
        if (package1.package > userBlance) {
            ...
            console.log(
                chalk.bold.blueBright("Dear User") +
                  ...
                  " " +
                  chalk.bold.red(
                    "Sorry our Company Is'nt providing any other service"
                  ) +
                  " " +
                  chalk.bold.green("| Try Again |")
              );
